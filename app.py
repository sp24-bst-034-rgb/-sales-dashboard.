...
with tab1:
    ...
    st.title("Welcome to the Premium Sales Dashboard")
    ...
    st.markdown("""
    ### Theory — Why Sales Dashboards Matter?
    Dashboards convert raw data into valuable insights.
    They help managers quickly track performance and identify opportunities.

    Visual tools used include:
    - Line charts (trends)
    - Distribution charts (profit spread)
    - Bubble/3D charts (multi-factor analysis)
    """)
...
with tab2:
    ...
    st.markdown("<h1 style='text-align:center;'>Premium Sales Dashboard</h1>", unsafe_allow_html=True)
    st.markdown("---")
    ...
    # 9. Profit Heatmap (Month vs Category)
...
with tab3:
    ...
    st.write("""
    ### Summary Insights
    - Revenue & Profit vary across months and regions  
    - Some categories perform consistently better  
    - Sales quantity and profit do not always increase together  
    """)

    st.success("Conclusion page complete with summary visuals.")
